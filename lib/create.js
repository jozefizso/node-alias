...
module.exports = exports = function (targetPath) {
  const statOptions = { bigint: false }
  var info = { version: 2, extra: [] }

  var parentPath = path.resolve(targetPath, '..')
  var targetStat = fs.statSync(targetPath, statOptions)
  var parentStat = fs.statSync(parentPath, statOptions)
  var volumePath = findVolume(targetPath, targetStat)
  var volumeStat = fs.statSync(volumePath, statOptions)

  console.log('Number.MAX_SAFE_INTEGER', Number.MAX_SAFE_INTEGER)
  console.log('targetStat', targetStat)
  console.log('parentStat', parentStat)
  console.log(util.inspect(targetStat))
